...
# 环境变量配置
EMAIL="shangfeng147@gmail.com"   # 登录邮箱
PASSWORD="@wengwcn0605"     # 登录密码

# 要保活的URL列表,多个用英文空格分隔
URLS="https://aws-usvadkwspg.cfapps.us10-001.hana.ondemand.com https://moontv-awsusvaizjvyb.cfapps.us10-001.hana.ondemand.com"  
